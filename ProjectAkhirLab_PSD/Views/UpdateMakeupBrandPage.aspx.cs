...
namespace ProjectAkhirLab_PSD.Views
{
    public partial class UpdateMakeupBrandPage : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Response<MakeupBrand> response = MakeupBrandController.getbrandbyID(id);
                        MakeupBrand brands = response.Payload;
                        brandnametxt.Text = brands.MakeupBrandName;
                        ratingtxt.Text = brands.MakeupBrandRating.ToString();
        ...
        protected void Updatebrand_Click(object sender, EventArgs e)
        {
            ...
            Response<MakeupBrand> brand = MakeupBrandController.Updatebrand(id, name, rating);
            if (brand.Success)
            {
                Response.Redirect("~/Views/ManageMakeupPage.aspx");
            }
