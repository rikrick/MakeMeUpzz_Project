...
namespace ProjectAkhirLab_PSD.Views
{
    public partial class UpdateMakeupTypePage : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Response<MakeupType> response = MakeupTypeController.gettypebyID(id);
                        MakeupType type = response.Payload;
                        typenametxt.Text = type.MakeupTypeName;
        ...
        protected void Updatetype_Click(object sender, EventArgs e)
        {
            ...
            Response<MakeupType> type = MakeupTypeController.Updatetype(id, name);
            if (type.Success)
            {
                Response.Redirect("~/Views/ManageMakeupPage.aspx");
            }
