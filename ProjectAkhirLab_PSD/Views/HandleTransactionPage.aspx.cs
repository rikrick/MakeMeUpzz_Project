...
namespace ProjectAkhirLab_PSD.Views
{
    public partial class HandleTransactionPage : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        handlegv.DataSource = response.Payload;
                        handlegv.DataBind();
                    }
                }
            }
        ...
        protected void handlebtn_Click(object sender, EventArgs e)
        {
            ...
            int tranid = Convert.ToInt32(btn.CommandArgument);
            Response<TransactionHeader> header = TransactionHeaderController.Updateheader(tranid);
